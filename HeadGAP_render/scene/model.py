...
from scene.eg3d.volumetric_rendering.renderer import ImportanceRenderer, sample_from_planes
from scene.eg3d.volumetric_rendering.ray_sampler import RaySampler
from scene.eg3d.superresolution import SuperresolutionHybrid8XDC
from scene.eg3d.networks_stylegan2 import FullyConnectedLayer
from scene.eg3d.triplane import OSGDecoder
from scene.eg3d.networks_stylegan2 import Generator as StyleGAN2Backbone
...
class TriGenerator(nn.Module):
    ...
    def forward(self, z, c, truncation_psi=1, truncation_cutoff=None, neural_rendering_resolution=None,
        ...
        return self.synthesis(ws, update_emas=update_emas, neural_rendering_resolution=neural_rendering_resolution,
...
class TriplaneRenderer(nn.Module):
    ...
    def synthesis(self, planes, c, neural_rendering_resolution=None):
        ...
        feature_samples, depth_samples, _ = self.renderer(planes, self.decoder, ray_origins, ray_directions,
    ...
    def sample_density(self, planes, coordinates, directions):
        ...
        '''
        sampled_features = sample_from_planes(self.renderer.plane_axes, planes, coordinates, padding_mode='zeros',
...
class EncoderF(nn.Module):
    def __init__(self, mode="Normal") -> None:
        ...
        self.blocks = nn.ModuleList(
            [Block(dim=1024, num_heads=4, mlp_ratio=2, sr_ratio=1) for _ in range(self.blocks_num)])
...
class EG3DInvEncoder(nn.Module):
    def __init__(
        ...
        self.mode = mode
        deeplab = DeepLabV3(in_channels=in_channels, encoder_name=encoder_name,
                            encoder_depth=encoder_depth)  # encoder_depth [3, 5]
