...
def apply_global_tfm_to_camera(E, Rh, Th):
    ...
    Args:
        - E: Array (3, 3) E_CW T_w_c
        - Rh: Array (3, ) R_CH T_h_c
        - Th: Array (3, ) T_CH T_h_c
...
def apply_global_tfm_to_camera_mv(E, Rh, Th):
    r""" Get camera extrinsics that considers global transformation.
    ...
    trans = np.linalg.inv(global_tfms)[:3, 3:4]
    rotation = E[:3, :3].dot(global_rot)
